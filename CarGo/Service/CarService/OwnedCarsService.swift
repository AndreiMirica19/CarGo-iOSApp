...
struct OwnedCarsService: OwnedCarsProtocol {
    static func ownedCars(ownerId: String) async throws -> (Data?, NetworkError?) {
        guard var urlComponents = URLComponents(string: ApiEndpoint.url + ApiEndpoint.ownedCars.rawValue) else {
